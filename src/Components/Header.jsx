...
const Header = () => {
  ...
  return (
    <div className=''>
      <div className={`bg-[#ffffff21] ${menuOpen ?'text-black w-full p-5 backdrop-blur-0' : 'p-1 m-4 text-[#fff]  w-[92vw] rounded-full shadow-2xl backdrop-blur-sm'} flex lg:hidden flex-row justify-between items-center fixed left-0 top-0 z-50 w-full`}>
